...
function Home() {
    return (
        <div>
            <div style={{maxWidth: '960px'}}><a href='/event'><img className='Event_banner' src='https://slaimuda.github.io/ectl/static/media/confluence-of-nothingness.827775f871c90c68fa4a.jpg'/></a></div>
            <div>
                <h4>이벤트기간</h4>
